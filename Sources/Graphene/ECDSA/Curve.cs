namespace ECDSA
{
    public class Curve
    {
        ...
        private Curve(string name)
        {
            ...
            var a = new System.Numerics.BigInteger(new byte[]
            {
            ...
            var b = new System.Numerics.BigInteger(new byte[]
            {
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            ...
            var p = new System.Numerics.BigInteger(new byte[]
            {
            ...
            var gx = new System.Numerics.BigInteger(new byte[]
            {
            ...
            var gy = new System.Numerics.BigInteger(new byte[]
            {
            ...
            var r = new System.Numerics.BigInteger(new byte[]
            {
            ...
            var curveSecp256K1 = ellipticcurve.CurveFp(p, a, b);
            var generatorSecp256K1 = ellipticcurve.Point(curveSecp256K1, gx, gy, r);
        }
        ...
        public Curve Secp256K1
        {
            get
            {
                return new Curve("SECP256k1", (1, 3, 132, 0, 10), "secp256k1");
            }
        }
    }
}