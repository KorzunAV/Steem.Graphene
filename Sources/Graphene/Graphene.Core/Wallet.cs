...
{
    /// <summary>
    /// The wallet is meant to maintain access to private keys for your accounts. 
    /// It either uses manually provided private keys or uses a SQLite database managed by storage.py. 
    ...
    public class Wallet
    {
        ...
        /// </summary>
        /// <returns></returns>
        public bool getPostingKeyForAccount()//def getPostingKeyForAccount(self, name):
        {
