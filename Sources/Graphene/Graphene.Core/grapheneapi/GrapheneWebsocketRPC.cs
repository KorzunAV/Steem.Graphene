...
namespace Graphene.Core.grapheneapi
{
    /// <summary>
    ...
    ///  </summary>
    public class GrapheneWebsocketRPC //class GrapheneWebsocketRPC(object):
    {
        ...
        public int get_request_id() //    def get_request_id(self):
        {
        ...
        public object wsconnect() //    def wsconnect(self):
        {
            throw new NotImplementedException();
            //cnt = 0
            //while True:
        ...
        public object register_apis() //    def register_apis(self):
        {
            throw new NotImplementedException();
        ...
        /// </summary>
        /// <returns></returns>
        public object rpcexec()//    def rpcexec(self, payload):
        {
            throw new NotImplementedException();
