...
namespace Graphene.Core
{
    ...
    ///:param str accountName: Name of the account
    ///:param Steem steem_instance: Steem() instance to use when accesing a RPC
    ///:param bool lazy: Use lazy loading
    /// </summary>
    public class Account//class Account(dict):
    {
        private string Name;
        private bool Cached;
        private Steem Steem;

        public Account(string accountName, Steem steem, bool lazy = false)//    def __init__(self,accountName,steem_instance= None,lazy= False,):
        {
        ...
        private void Refresh()//def refresh(self):
        {
            //account = self.steem.rpc.get_account(self.name)
            var account = Steem.RPC.ExecuteRemoteCall("get_account", this.Name);
            //if not account:
        ...
        //        try:
        //            last_item = self.steem.rpc.get_account_history(self.name, -1, 0)[0]
        //[0]
        //except IndexError:
        //            return 0
        //        else:
